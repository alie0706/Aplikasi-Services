                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                 <?php echo anchor('customer_alat/post/'.$record['id_customer'],'Tambah Data Alat',array('class'=>'btn btn-danger btn-sm')) ?>
                            </div>
                            <div class="panel-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php $no=1; foreach ($recordalat->result() as $r) { ?>
                                            <tr class="gradeU">
                                                ...
                                                <td class="center">
                                                    <?php echo anchor('customer_alat/edit/'.$r->id_customer_alat,'Edit'); ?> | 
                                                    <?php echo anchor('customer_alat/delete/'.$r->id_customer_alat,'Delete'); ?> |
                                                    <a href="<?php echo '../../customer_alat/cetak_barcode/'.$r->id_customer_alat ?>" target="blank">Cetak Barcode</a> 
